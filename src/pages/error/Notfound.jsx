...
const Notfound = () => {
    ...
    return (
        <Box>
            <Paper sx={{ px: 2, py: 1, boxShadow: 'none', borderBottom: '1px solid #ededed;' }}>
                <Container maxWidth="xl">
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1, cursor: 'pointer' }} onClick={() => { navigate('/') }}>
                        <Box>
                            <Box component={'img'} src={Logo} sx={{ maxWidth: 40, minWidth: 35, transition: '.5s', }} alt="" />
                        </Box>
                        <Box>
            ...
            <Box sx={{ minHeight: "calc(100vh - 70px)", display: "flex", alignItems: "center", }}>
                <Container maxWidth="xl">
